...
public class ReviewService {
    ...
    public Review saveReview(Review review) {
        ...
        fileStorageService.logDetails("REVIEW_CREATION",
                String.format("ID: %d, User: %s, Agent: %s, Rating: %d, Comment: %s",
                        savedReview.getId(), savedReview.getUser().getEmail(), savedReview.getAgent().getEmail(),
                        savedReview.getRating(), savedReview.getComment()));
